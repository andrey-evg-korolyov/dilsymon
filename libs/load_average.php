...
//    $result = $mysqli->query("INSERT INTO load_average (min_1, min_5, min_15) VALUES ('$min_1','$min_5',$min_15)");
    ...
    //если эти 2 строки(ниже) раскоментировать данные в БД сохраняются и через крон тоже всё сохраняется
    // но при каждом перезапуске страницы идет сохранение.
    // а если оставить закоментир то код работает не корректно
    // загрузка в БД не идет
    // но из базы все данные отображает нормально
    // 
    // 
    //
